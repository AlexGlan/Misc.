...
class App extends React.Component {
    ...
    expandEditor() {
        this.setState((prevValue) => ({
            visibility: {
                hideEditor: prevValue.visibility.hideEditor,
                hidePreviewer: !prevValue.visibility.hidePreviewer
            }
        })); 
        ...
        return (
            <div className='container'>
                <Editor
                    ...
                    handleExpand={this.expandEditor}
                    visibility={this.state.visibility}
                />
                <Previewer
                    text={this.state.text}
                    handleExpand={this.expandPreviewer}
                    visibility={this.state.visibility}
                />
            </div>            
        )
